...
namespace VideoEditorD3D.Direct3D.Canvas
{
    ...
    {
        public CanvasLayer(int index, IApplication application)
        {
            Index = index;
        ...
        int CanvasWidth => Application.Width;
        int CanvasHeight => Application.Height;
        Device Device => Application.Device;
        CharacterCollection TextCharacters => Application.Characters;
