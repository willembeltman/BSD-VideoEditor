...
{
    // Struct voor het opslaan van de display-instellingen
    ...
    public struct DEVMODE
    {
        ...
        public int dmNup;
        public int dmBitsPerPel1;
        public int dmPelsWidth1;
        public int dmPelsHeight1;
        public int dmDisplayFlags1;
        public int dmNup1;
        public int dmPelsWidth2;
        public int dmPelsHeight2;
        public int dmDisplayFlags2;
        public int dmNup2;
        public int dmBitsPerPel2;
        public int dmPelsWidth3;
        public int dmPelsHeight3;
        public int dmDisplayFlags3;
        public int dmNup3;
        public int dmDisplayFrequency;  // Verversingssnelheid
    }
    ...
    public static void Test()
    {
        ...
        int result = EnumDisplaySettings(Screen.PrimaryScreen.DeviceName, ENUM_REGISTRY_SETTINGS, ref devMode);

        if (result != 0)
        {
            Console.WriteLine($"Verversingssnelheid: {devMode.dmBitsPerPel}Hz");
        }
        else
        {
            Console.WriteLine("Kan de verversingssnelheid niet ophalen.");
        }
    }
}
